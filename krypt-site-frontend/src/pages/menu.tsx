        ...
        <>
            <div className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-blue-800 via-purple-500 p-14 to-blue-600 shadow-lg">
                <div className="flex flex-col md:flex-row items-center justify-between">
                    <button className="text-3xl md:text-4xl font-extrabold bg-gradient-to-r from-yellow-400 via-pink-500 to-purple-500 bg-clip-text text-transparent drop-shadow-lg mb-2 md:mb-0"
                    >
                        KRYPTO SITE
                    </button>
